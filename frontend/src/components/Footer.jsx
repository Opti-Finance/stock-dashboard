      ...
      <div className="max-w-[950px] w-full mx-auto px-4">
        <div className="flex flex-wrap justify-between items-center">
          <div className="flex items-center mb-4 lg:mb-0">
            <img 
              src="https://www.pngmart.com/files/10/Dollar-Sign-PNG-Image.png" 
              alt="OmniFinance Solutions Logo" 
              className="h-20 mr-4"
            />
            <h2 className="text-2xl font-bold">OmniFinance Solutions</h2>
          </div>
...
const SocialLink = ({ href, icon: Icon }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">
